...
describe 'KeysPlugin', ->
  ...
  describe 'when known key is up', ->
    ...
    it 'fires specific up event', (done) ->
      plugin.on event: 'keys.up.knownkey', handler: (keyCode) -> done()

    it 'fires generic up event', (done) -> plugin.on event: 'keys.up', handler: (keyCode) -> done()
  ...
  describe 'when unknown key is up', ->
    ...
    it 'fires specific up event', (done) -> plugin.on event: 'keys.up.code.600', handler: (keyCode) -> done()
    it 'fires generic up event', (done) -> plugin.on event: 'keys.up', handler: (keyCode) -> done()

  describe 'when known key is down', ->
    beforeEach -> plugin.$onKeyDown 500

    it 'fires specific down event', (done) -> plugin.on event: 'keys.down.knownkey', handler: (keyCode) -> done()
    it 'fires generic down event', (done) -> plugin.on event: 'keys.down', handler: (keyCode) -> done()
  ...
  describe 'when unknown key is down', ->
    ...
    it 'fires specific down event', (done) -> plugin.on event: 'keys.down.code.600', handler: (keyCode) -> done()
    it 'fires generic down event', (done) -> plugin.on event: 'keys.down', handler: (keyCode) -> done()

  describe 'when known key is pressed', ->
    beforeEach -> plugin.$onKeyPress 500

    it 'fires specific press event', (done) -> plugin.on event: 'keys.press.knownkey', handler: (keyCode) -> done()
    it 'fires generic press event', (done) -> plugin.on event: 'keys.press', handler: (keyCode) -> done()

  describe 'when unknown key is pressed', ->
    beforeEach -> plugin.$onKeyPress 600

    it 'fires specific press event', (done) -> plugin.on event: 'keys.press.code.600', handler: (keyCode) -> done()
    it 'fires generic press event', (done) -> plugin.on event: 'keys.press', handler: (keyCode) -> done()
